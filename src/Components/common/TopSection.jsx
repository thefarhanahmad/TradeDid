      ...
      <div className="relative flex flex-col  pt-20 pb-8 md:py-0  justify-center items-center h-full  md:0 text-white">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="mt-8">
            ...
            <button className="hover:bg-orange-500 hover:text-white border border-orange-600 bg-white text-orange-500 font-semibold py-2 px-4 rounded-full  transition duration-200">
              Sign Up Now
            </button>
          </div>
        </div>
