...
export default function PriceList() {
  ...
  return (
    <>
      {/* For Desktop */}
      <div className="hidden bg-gray-50 md:flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-5xl">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div className="flex flex-row-reverse w-full justify-between gap-6  items-center">
      ...
      {/* For small devices md */}
      <div
        style={{
          backgroundImage:
            'url("https://cdn.vectorstock.com/i/preview-1x/18/96/pile-text-books-with-laptop-vector-24451896.webp")',
      ...
      >
        ...
        <div className="flex flex-col py-12 sm:px-12 px-2 justify-center bg-red-500 backdrop-blur bg-transparent shadow ">
          ...
          <div className="relative z-10 mt-8 sm:mx-auto sm:w-full sm:max-w-5xl px-4">
            <div className="">
