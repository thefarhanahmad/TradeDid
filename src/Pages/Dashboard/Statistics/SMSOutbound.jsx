      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <div className="flex items-center space-x-2">
            <label className="text-gray-600">Date / time (UTC)</label>
          ...
          <div className="flex items-center space-x-2">
            <label className="text-gray-600">Source address</label>
            <select className="bg-white border border-gray-300 rounded-md p-2">
              <option>Any</option>
        ...
        <div className="py-16 bg-white flex justify-center items-center rounded">
          <p>You have no outbound SMS logs for the selected time frame</p>
        </div>
      </div>
    </div>
  );
