...
const RegulatoryRequirements = () => {
  ...
  return (
    <div>
      <TopSection
        preText={"Regulatory requirements for phone numbers"}
        spanText={""}
        nextText={""}
        subheading={
          "Stay fully compliant with regulations by providing required end-user information in certain countries"
        }
        bgImg={
