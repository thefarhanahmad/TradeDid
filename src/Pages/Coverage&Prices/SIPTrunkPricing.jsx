...
const SIPTrunkPricing = () => {
  const texts = {
    beforeText: "",
    spanText: "Profitable outcomes",
    afterText: "for business VoIP communications",
    subPara: "Empower your business with a carrier-grade SIP Trunking solution",
  };

  const cardData = [
    {
      title: "Cost-efficient Local VoIP Termination",
      description:
        "Truly direct Local Dialing at competitive termination rates and premium voice quality.",
    },
    {
      title: "Pay-as-you-grow pricing",
      description:
        "Customized pricing to grow your business in a cost-efficient manner.",
    },
    {
    ...
    {
      title: "Unlimited SIP Trunking Capacity",
      description:
        "Outbound SIP Trunks with free unlimited concurrent VoIP channels.",
    },
    {
  ...
  return (
    <div>
      <TopSection
        preText={"Cost-efficient and elastic SIP Trunking"}
        spanText={"pricing"}
        nextText={""}
        subheading={
          "Powerful VoIP Termination solution for supporting your business growth globally"
        }
        bgImg={
...
export default SIPTrunkPricing;
